              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50 text-gray-700">
                    <th className="py-4 px-6 font-semibold border-b border-gray-200">Size</th>
                    <th className="py-4 px-6 font-semibold border-b border-gray-200">US</th>
                    <th className="py-4 px-6 font-semibold border-b border-gray-200">Bust (in)</th>
                    <th className="py-4 px-6 font-semibold border-b border-gray-200">Waist (in)</th>
                    <th className="py-4 px-6 font-semibold border-b border-gray-200">Hips (in)</th>
                  </tr>
                </thead>
                <tbody className="text-gray-600">
                  <tr className="border-b border-gray-100">
                    <td className="py-4 px-6 font-medium text-gray-900">Small (S)</td>
                  ...
                  <tr className="border-b border-gray-100">
                    <td className="py-4 px-6 font-medium text-gray-900">Medium (M)</td>
                  ...
                  <tr className="border-b border-gray-100">
                    <td className="py-4 px-6 font-medium text-gray-900">Large (L)</td>
                  ...
                  <tr>
                    <td className="py-4 px-6 font-medium text-gray-900">X-Large (XL)</td>
