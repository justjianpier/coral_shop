  ...
  const sectionLinks = [
    {
      ...
      links: [
        ...
        { id: "c3", name: "Women's Clothing", url: "/woman" },
        { id: "c4", name: "Jewelry", url: "/jewelry" },
        { id: "c5", name: "Best Sellers", url: "/best_sellers" },
      ],
    },
    {
      id: 2,
    ...
    },
    {
      ...
      links: [
        { id: "cs1", name: "Contact Us", url: "/contact_us" },
        { id: "cs2", name: "Shipping Info", url: "/shipping_info" },
        { id: "cs3", name: "Returns", url: "/returns" },
        { id: "cs4", name: "FAQ", url: "/faq" },
        { id: "cs5", name: "Size Guide", url: "/size_guide" },
      ],
    },
  ];
